                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 {{ $errors->has('post_title') ? ' has-error' : '' }}">
                                <input id="post_title" type="text" aria-required="true" name="post_title" class="form-control"
                                       placeholder="Post Title" value="{{ old('post_title') }}" aria-invalid="true" required >
                            ...
                            <div class="col-sm-12 {{ $errors->has('post_body') ? ' has-error' : '' }}">
                                <textarea id="post_body" type="text" aria-required="true" name="post_body" class="form-control"
                                          value="{{ old('post_body') }}" placeholder="Post Body" aria-invalid="true" required ></textarea>
