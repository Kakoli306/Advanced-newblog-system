...
class PostController extends Controller
{
    ...
    public function post()
    {
        ...
        // exit();
        return view('frontEnd.posts.post', ['categories' => $categories]);
    }
    ...
    public function view($post_id)
    {
        ...
        return view('frontEnd.posts.view', ['posts' => $posts, 'categories' => $categories,
            'likepress' => $likepress, 'dislikepress' =>$dislikepress, 'comments' => $comments ]);
    ...
    public function edit($post_id){
        ...
        return view('frontEnd.posts.edit',['categories' => $categories,
    ...
    public function category($cat_id){
        ...
        //  return $posts;
        //  exit();
        return view('frontEnd.categories.categoriesposts',['categories'=> $categories, 'posts'=> $posts]);
    }
    ...
    public function search(Request $request){
        ...
        return view('frontEnd.posts.searchposts',['profile'=> $profile, 'posts'=>$posts]);
